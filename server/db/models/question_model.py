...
class QuestionModel(Base):
    ...
    kb_id = Column(String(50), comment='知识库id(为空则使用llm对话)')
    ...
    def __repr__(self):
        return f"<Question(id='{self.id}', query='{self.query}', kb_id='{self.kb_id}', answer='{self.answer}',tap_count='{self.tap_count}',enable='{self.enable}', create_time='{self.create_time}')>"
